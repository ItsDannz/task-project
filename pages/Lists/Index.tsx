...
import { Plus, Pencil, Trash2, CheckCircle2, XCircle, Check } from 'lucide-react';
import { Link } from '@inertiajs/react';
import AppLayout from '@/layouts/app-layout';
import { type BreadcrumItem } from '/@types';
...
export default function ListsIndex({ lists, flash }: Props){
    ...
    const { data, setData, post, put, processing, reset, delete: destroy, errors } = useForm({
        title: '',
        description: '',
    });
